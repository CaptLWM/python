...
expense_list2016_dir = '/Users/iwonmin/Desktop/python/ch20_project/seoul_expense/2017/'
...
year = 2017
expense_list_year_dir = '/Users/iwonmin/Desktop/python/ch20_project/seoul_expense/' + str(year) + '/'
...
def select_columns_save_file(year, data_folder, drop_columns_list):
    ...
    df_year_drop = df_year.drop(columns=drop_columns_list) # 결측치 제거
