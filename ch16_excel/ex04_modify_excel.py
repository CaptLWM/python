...
df = pd.read_excel('/Users/iwonmin/Desktop/python/ch16_excel/담당자별_판매량_Andy사원.xlsx')
print(df)
'''
...
import glob
excel_file_name = '/Users/iwonmin/Desktop/python/ch16_excel/담당자별_판매량_Andy사원_new.xlsx'
