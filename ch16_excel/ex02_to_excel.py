...
'''
#excel_writer 객체 생성
excel_writer = pd.ExcelWriter('/Users/iwonmin/Desktop/python/ch16_excel/학생시험성적2.xlsx', engine='xlsxwriter')
#생성한 객체에 데이터 입력
...
excel_writer2 = pd.ExcelWriter(
    '/Users/iwonmin/Desktop/python/ch16_excel/학생시험성적3.xlsx', engine='xlsxwriter')
...
excel_writer3 = pd.ExcelWriter(
    '/Users/iwonmin/Desktop/python/ch16_excel/학생시험성적4.xlsx', engine='xlsxwriter')
