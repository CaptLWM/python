...
print(soup.find_all('a')) # 모든 리턴함수 호출
...
print(soup2.select('body h1')) # body에 h1태그
# [<h1>책 정보</h1>]

print(soup2.select('body p')) # body에 p태그 선택
...
f = open('/Users/iwonmin/Desktop/python/ch17_webscraping/HTML_example_my_site.html', encoding='utf-8')
html3 = f.read()
f.close()
