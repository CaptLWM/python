...
folder = '/Users/iwonmin/Desktop/python/ch17_webscraping/download'  # 이미지를 내려받을 폴더를 지정
...
figure_folder = "/Users/iwonmin/Desktop/python/ch17_webscraping/download" # 이미지를 내려받을 폴더를 지정  

reshot_image_urls = get_image_url(reshot_url) # 이미지 파일의 주소 가져오기

num_of_download_image = 7 # 내려받을 이미지 개수를 지정 / 한번에 많이 하지 말것. 사이트 차단 당할 수 이씀
